...
import 'package:flutter_qiblah_latest_example/location_error_widget.dart';
    ...
    return FutureBuilder(
      ...
      builder: (_, AsyncSnapshot<Position?> snapshot) {
        ...
        return StreamBuilder(
          ...
          builder:
              (_, AsyncSnapshot<LatLng> snapshot) => GoogleMap(
                ...
                circles: <Circle>{
                  Circle(
                    ...
                    fillColor: Theme.of(
                      context,
                    ).primaryColorLight.withAlpha(100),
                    strokeWidth: 1,
                    strokeColor: Theme.of(
                      context,
                    ).primaryColorDark.withAlpha(100),
                    zIndex: 3,
                  ),
                },
                polylines: <Polyline>{
