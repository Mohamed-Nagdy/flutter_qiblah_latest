...
import 'package:flutter_qiblah_latest/src/utils.dart';
...
class FlutterQiblah {
  static const MethodChannel _channel = MethodChannel('flutter_qiblah_latest');
  ...
  static Stream<QiblahDirection> _merge<A, B>(
    Stream<A> streamA,
    Stream<B> streamB,
  ) => streamA.combineLatest<B, QiblahDirection>(streamB, (dir, pos) {
