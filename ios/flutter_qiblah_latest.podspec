...
# Run `pod lib lint flutter_qiblah_latest.podspec` to validate before publishing.
#
Pod::Spec.new do |s|
  s.name             = 'flutter_qiblah_latest'
  s.version          = '0.0.1'
...
Flutter Qiblah is a package that allows you to display Qiblah direction in you app with support for both Android and iOS
  ...
  # s.resource_bundles = {'flutter_qiblah_latest_privacy' => ['Resources/PrivacyInfo.xcprivacy']}
end
